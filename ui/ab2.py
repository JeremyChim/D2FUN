# Form implementation generated from reading ui file 'ab2.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.menubar.setGeometry(QtCore.QRect(0, 0, 1067, 24))
        ...
        self.actionopen_now = QtGui.QAction(parent=MainWindow)
        self.actionopen_now.setObjectName("actionopen_now")
        self.menufile.addAction(self.actionopen)
        self.menufile.addAction(self.actionsave)
        self.menufile.addAction(self.actionsave_as)
        self.menufile.addAction(self.actionopen_now)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButton.setText(_translate("MainWindow", "sap(space)"))
        self.pushButton_10.setText(_translate("MainWindow", "charges(c)"))
        self.pushButton_3.setText(_translate("MainWindow", "cd(d)"))
        self.pushButton_12.setText(_translate("MainWindow", "=1(1)"))
        self.pushButton_15.setText(_translate("MainWindow", "+25%(2)"))
        self.pushButton_14.setText(_translate("MainWindow", "+33%(3)"))
        self.pushButton_16.setText(_translate("MainWindow", "+5(4)"))
        self.pushButton_13.setText(_translate("MainWindow", "+50(5)"))
        self.pushButton_17.setText(_translate("MainWindow", "+500(6)"))
        self.pushButton_19.setText(_translate("MainWindow", "+75%(7)"))
        self.pushButton_18.setText(_translate("MainWindow", "+100%(9)"))
        self.pushButton_11.setText(_translate("MainWindow", "=0(0)"))
        self.pushButton_20.setText(_translate("MainWindow", "-"))
        self.pushButton_21.setText(_translate("MainWindow", "+"))
        self.pushButton_2.setText(_translate("MainWindow", "reload(r)"))
        self.pushButton_9.setText(_translate("MainWindow", "←(backspace)"))
        self.pushButton_7.setText(_translate("MainWindow", "→(tab)"))
        self.pushButton_5.setText(_translate("MainWindow", "cut(x)"))
        self.pushButton_4.setText(_translate("MainWindow", "paste(v)"))
        self.pushButton_6.setText(_translate("MainWindow", "undo(z)"))
        self.pushButton_8.setText(_translate("MainWindow", "save(ctrl+s)"))
        self.menufile.setTitle(_translate("MainWindow", "file"))
        self.actionopen.setText(_translate("MainWindow", "open"))
        self.actionsave.setText(_translate("MainWindow", "save"))
        self.actionsave_as.setText(_translate("MainWindow", "save as"))
        self.actionopen_now.setText(_translate("MainWindow", "open now"))
